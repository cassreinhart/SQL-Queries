...
SELECT app_name, reviews FROM analytics GROUP BY app_name ORDER BY reviews, app_name LIMIT 5;
...
SELECT app_name, reviews, min_installs, min_installs/reviews AS proportion_inst_to_rev FROM analytics WHERE min_installs > 100000 ORDER BY proportion_inst_to_rev DESC LIMIT 1;
